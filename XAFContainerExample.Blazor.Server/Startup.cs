...
public class Startup {
        ...
        services.AddXaf(Configuration, builder => {
            ...
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options => options.PreFetchReferenceProperties())
                    .WithDbContext<XAFContainerExample.Module.BusinessObjects.XAFContainerExampleEFCoreDbContext>((serviceProvider, options) => {
                        ...
                        if(String.IsNullOrEmpty(connectionString) && Configuration.GetConnectionString("ConnectionString") != null) {
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        ...
        //Remove this line if you are going to run the app behind Nginx reverse proxy
